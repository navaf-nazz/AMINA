...
Asena.addCommand({on: 'text', fromMe: false, deleteCommand: false}, (async (message, match) => {
    if (message.jid === '919562803423-1627735504@g.us') {
         ...
         let regex20 = new RegExp('botsetting')
	 let regex21 = new RegExp('yblockedfind')
          if (regex1.test(message.message)) {              
             await message.client.sendMessage(message.jid,'\n *「 ENNA OK😍😍 」*', MessageType.text, {quoted: message.data })
         } 
         else if (regex2.test(message.message)) {
            await message.client.sendMessage(message.jid,'my name is Amina' , MessageType.text, {quoted: message.data })
         }
           ...
           await message.client.sendMessage(message.jid,'i know him he is my creator', MessageType.text, {quoted: message.data })
            ...
            await message.client.sendMessage(message.jid,'```I am Amina.```', MessageType.text, {quoted: message.data })
         }
            ...
            await message.client.sendMessage(message.jid,' ▣ *TYPE* ▣  ◯⦁⦁━━► ┌ *「 !owner 」* \n\n\n', MessageType.text, {quoted: message.data })
         }   
            ...
            await message.client.sendMessage(message.jid,'┌ *「 ABOUT 」* \n\n\n *HELLO I AM AMINA USED FOR ENTERTAINMENT PURPOSE AS YOU ARE MY USERS YOU SHOULD MAINTAIN YOUR DIGNITY*', MessageType.text, {quoted: message.data })
         }
            ...
            await message.client.sendMessage(message.jid,'*https://tinyurl.com/47sns4j8*', MessageType.text, {quoted: message.data })
         }
